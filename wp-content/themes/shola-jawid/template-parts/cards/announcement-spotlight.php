 ...
 * smaller list (title + date only) below it — so it's visually obvious
 * which is newest without the tile needing to be tall to avoid looking
 * empty. Changed same day as the tile's first version, after Farhad
 * flagged from a live screenshot that a single announcement left most
 * of a two-row-tall tile blank.
 *
